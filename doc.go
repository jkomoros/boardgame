...
following table:
	...
	| PolicyOrder    | All values replaced by generic component                        | Ids reveals all Ids in order                                     | PolicyOrder is similar to PolicyLen, but the order of components is observable                        |
