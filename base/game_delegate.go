...
func (g *GameDelegate) ChatPolicyForPlayer(state boardgame.ImmutableState, player boardgame.PlayerIndex) boardgame.ChatPolicy {
	...
	// Note: DM channels are not yet implemented. When dmChat support is
	// added, the server layer will augment the policy with "dm/userA/userB"
	// channels based on UserIDsForGame.
