...
func TestDefaultTemplatePlaceholdersCoveredByEmittedBindings(t *testing.T) {
	...
	canonicalSpecs := map[string]Spec{
		...
		"mayMoveFirstTo":                   MayMoveFirstTo("game.SrcStack", "game.DstStack"),
		"mayMoveFirstToSlot":               MayMoveFirstToSlot("game.SrcStack", "game.DstStack", "move.SomeSlot"),
		...
		"componentPropEquals":              ComponentPropEquals(FirstOccupied("game.SomeStack"), "Type", "Card"),
		"componentPropNotEquals":           ComponentPropNotEquals(FirstOccupied("game.SomeStack"), "Type", "Card"),
		"componentPropsEqual":              ComponentPropsEqual(FirstOccupied("game.SomeStack"), OccupiedOrdinal("game.SomeStack", 1), "Type"),
		"componentPropsNotEqual":           ComponentPropsNotEqual(FirstOccupied("game.SomeStack"), OccupiedOrdinal("game.SomeStack", 1), "Type"),
		"inPhase":                          InPhase(),
