...
func (m *__moveDealCardsToThreeReader) PropMutable(name string) bool {
	switch name {
	}
...
func (m *__moveDealCardsToThreeReader) ConfigureEnumProp(name string, value enum.Val) error {
...
func (m *__moveDealCardsToThreeReader) ConfigureStackProp(name string, value boardgame.Stack) error {
...
func (m *__moveDealCardsToThreeReader) ConfigureTimerProp(name string, value boardgame.Timer) error {
