...
// Implementation for AdminPlayer

var ȧutoGeneratedAdminPlayerReaderProps = map[string]boardgame.PropertyType{
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedAdminPlayerReader struct {
	data *AdminPlayer
}

func (a *ȧutoGeneratedAdminPlayerReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedAdminPlayerReaderProps
}

func (a *ȧutoGeneratedAdminPlayerReader) Prop(name string) (interface{}, error) {
	props := a.Props()
...
func (a *ȧutoGeneratedAdminPlayerReader) PropMutable(name string) bool {
	switch name {
...
func (a *ȧutoGeneratedAdminPlayerReader) SetProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedAdminPlayerReader) ConfigureProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedAdminPlayerReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {

	switch name {
	case "TargetPlayerIndex":
		return a.data.TargetPlayerIndex, nil
...
func (a *ȧutoGeneratedAdminPlayerReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {

	switch name {
	case "TargetPlayerIndex":
		a.data.TargetPlayerIndex = value
		return nil
...
func (a *ȧutoGeneratedAdminPlayerReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (a *ȧutoGeneratedAdminPlayerReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for AdminPlayer
func (a *AdminPlayer) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedAdminPlayerReader{a}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for AdminPlayer
func (a *AdminPlayer) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedAdminPlayerReader{a}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for AdminPlayer
func (a *AdminPlayer) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedAdminPlayerReader{a}
}
...
// Implementation for AllPlayersSubmitted

var ȧutoGeneratedAllPlayersSubmittedReaderProps = map[string]boardgame.PropertyType{}

type ȧutoGeneratedAllPlayersSubmittedReader struct {
	data *AllPlayersSubmitted
}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedAllPlayersSubmittedReaderProps
}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) Prop(name string) (interface{}, error) {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedAllPlayersSubmittedReader) PropMutable(name string) bool {
	switch name {
	}
...
func (a *ȧutoGeneratedAllPlayersSubmittedReader) SetProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedAllPlayersSubmittedReader) ConfigureProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedAllPlayersSubmittedReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {

	return 0, errors.New("No such PlayerIndex prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndex prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (a *ȧutoGeneratedAllPlayersSubmittedReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for AllPlayersSubmitted
func (a *AllPlayersSubmitted) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedAllPlayersSubmittedReader{a}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for AllPlayersSubmitted
func (a *AllPlayersSubmitted) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedAllPlayersSubmittedReader{a}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for AllPlayersSubmitted
func (a *AllPlayersSubmitted) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedAllPlayersSubmittedReader{a}
}

// Implementation for AnyPlayer

var ȧutoGeneratedAnyPlayerReaderProps = map[string]boardgame.PropertyType{
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedAnyPlayerReader struct {
	data *AnyPlayer
}

func (a *ȧutoGeneratedAnyPlayerReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedAnyPlayerReaderProps
}

func (a *ȧutoGeneratedAnyPlayerReader) Prop(name string) (interface{}, error) {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedAnyPlayerReader) PropMutable(name string) bool {
	switch name {
	case "TargetPlayerIndex":
		return true
	}
...
func (a *ȧutoGeneratedAnyPlayerReader) SetProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedAnyPlayerReader) ConfigureProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedAnyPlayerReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {
...
func (a *ȧutoGeneratedAnyPlayerReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {
...
func (a *ȧutoGeneratedAnyPlayerReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (a *ȧutoGeneratedAnyPlayerReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for AnyPlayer
func (a *AnyPlayer) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedAnyPlayerReader{a}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for AnyPlayer
func (a *AnyPlayer) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedAnyPlayerReader{a}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for AnyPlayer
func (a *AnyPlayer) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedAnyPlayerReader{a}
}
...
// Implementation for DrawToPlayer

var ȧutoGeneratedDrawToPlayerReaderProps = map[string]boardgame.PropertyType{
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedDrawToPlayerReader struct {
	data *DrawToPlayer
}

func (d *ȧutoGeneratedDrawToPlayerReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedDrawToPlayerReaderProps
}

func (d *ȧutoGeneratedDrawToPlayerReader) Prop(name string) (interface{}, error) {
	props := d.Props()
	propType, ok := props[name]
...
func (d *ȧutoGeneratedDrawToPlayerReader) PropMutable(name string) bool {
	switch name {
	case "TargetPlayerIndex":
		return true
	}
...
func (d *ȧutoGeneratedDrawToPlayerReader) SetProp(name string, value interface{}) error {
	props := d.Props()
	propType, ok := props[name]
...
func (d *ȧutoGeneratedDrawToPlayerReader) ConfigureProp(name string, value interface{}) error {
	props := d.Props()
	propType, ok := props[name]
...
func (d *ȧutoGeneratedDrawToPlayerReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {
...
func (d *ȧutoGeneratedDrawToPlayerReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {
...
func (d *ȧutoGeneratedDrawToPlayerReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (d *ȧutoGeneratedDrawToPlayerReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for DrawToPlayer
func (d *DrawToPlayer) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedDrawToPlayerReader{d}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for DrawToPlayer
func (d *DrawToPlayer) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedDrawToPlayerReader{d}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for DrawToPlayer
func (d *DrawToPlayer) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedDrawToPlayerReader{d}
}
...
// Implementation for ForceFinishTurn

var ȧutoGeneratedForceFinishTurnReaderProps = map[string]boardgame.PropertyType{}

type ȧutoGeneratedForceFinishTurnReader struct {
	data *ForceFinishTurn
}

func (f *ȧutoGeneratedForceFinishTurnReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedForceFinishTurnReaderProps
}

func (f *ȧutoGeneratedForceFinishTurnReader) Prop(name string) (interface{}, error) {
	props := f.Props()
	propType, ok := props[name]
...
func (f *ȧutoGeneratedForceFinishTurnReader) PropMutable(name string) bool {
	switch name {
	}
...
func (f *ȧutoGeneratedForceFinishTurnReader) SetProp(name string, value interface{}) error {
	props := f.Props()
	propType, ok := props[name]
...
func (f *ȧutoGeneratedForceFinishTurnReader) ConfigureProp(name string, value interface{}) error {
	props := f.Props()
	propType, ok := props[name]
...
func (f *ȧutoGeneratedForceFinishTurnReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {

	return 0, errors.New("No such PlayerIndex prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndex prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (f *ȧutoGeneratedForceFinishTurnReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for ForceFinishTurn
func (f *ForceFinishTurn) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedForceFinishTurnReader{f}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for ForceFinishTurn
func (f *ForceFinishTurn) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedForceFinishTurnReader{f}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for ForceFinishTurn
func (f *ForceFinishTurn) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedForceFinishTurnReader{f}
}
...
var ȧutoGeneratedActivateInactivePlayerReaderProps = map[string]boardgame.PropertyType{
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedActivateInactivePlayerReader struct {
	data *ActivateInactivePlayer
}

func (a *ȧutoGeneratedActivateInactivePlayerReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedActivateInactivePlayerReaderProps
}

func (a *ȧutoGeneratedActivateInactivePlayerReader) Prop(name string) (interface{}, error) {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedActivateInactivePlayerReader) PropMutable(name string) bool {
	switch name {
	case "TargetPlayerIndex":
		return true
	}
...
func (a *ȧutoGeneratedActivateInactivePlayerReader) SetProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedActivateInactivePlayerReader) ConfigureProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedActivateInactivePlayerReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {
...
func (a *ȧutoGeneratedActivateInactivePlayerReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {
...
func (a *ȧutoGeneratedActivateInactivePlayerReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (a *ȧutoGeneratedActivateInactivePlayerReader) TimerProp(name string) (boardgame.Timer, error) {
...
// Implementation for MoveComponentToSlot

var ȧutoGeneratedMoveComponentToSlotReaderProps = map[string]boardgame.PropertyType{
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedMoveComponentToSlotReader struct {
	data *MoveComponentToSlot
}

func (m *ȧutoGeneratedMoveComponentToSlotReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedMoveComponentToSlotReaderProps
}

func (m *ȧutoGeneratedMoveComponentToSlotReader) Prop(name string) (interface{}, error) {
	props := m.Props()
	propType, ok := props[name]
...
func (m *ȧutoGeneratedMoveComponentToSlotReader) PropMutable(name string) bool {
	switch name {
	case "TargetPlayerIndex":
		return true
	}
...
func (m *ȧutoGeneratedMoveComponentToSlotReader) SetProp(name string, value interface{}) error {
	props := m.Props()
	propType, ok := props[name]
...
func (m *ȧutoGeneratedMoveComponentToSlotReader) ConfigureProp(name string, value interface{}) error {
	props := m.Props()
	propType, ok := props[name]
...
func (m *ȧutoGeneratedMoveComponentToSlotReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {
...
func (m *ȧutoGeneratedMoveComponentToSlotReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {
...
func (m *ȧutoGeneratedMoveComponentToSlotReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (m *ȧutoGeneratedMoveComponentToSlotReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for MoveComponentToSlot
func (m *MoveComponentToSlot) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedMoveComponentToSlotReader{m}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for MoveComponentToSlot
func (m *MoveComponentToSlot) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedMoveComponentToSlotReader{m}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for MoveComponentToSlot
func (m *MoveComponentToSlot) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedMoveComponentToSlotReader{m}
}
...
// Implementation for ReplenishMarket

var ȧutoGeneratedReplenishMarketReaderProps = map[string]boardgame.PropertyType{}

type ȧutoGeneratedReplenishMarketReader struct {
	data *ReplenishMarket
}

func (r *ȧutoGeneratedReplenishMarketReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedReplenishMarketReaderProps
}

func (r *ȧutoGeneratedReplenishMarketReader) Prop(name string) (interface{}, error) {
	props := r.Props()
	propType, ok := props[name]
...
func (r *ȧutoGeneratedReplenishMarketReader) PropMutable(name string) bool {
	switch name {
	}
...
func (r *ȧutoGeneratedReplenishMarketReader) SetProp(name string, value interface{}) error {
	props := r.Props()
	propType, ok := props[name]
...
func (r *ȧutoGeneratedReplenishMarketReader) ConfigureProp(name string, value interface{}) error {
	props := r.Props()
	propType, ok := props[name]
...
func (r *ȧutoGeneratedReplenishMarketReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {

	return 0, errors.New("No such PlayerIndex prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndex prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (r *ȧutoGeneratedReplenishMarketReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for ReplenishMarket
func (r *ReplenishMarket) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedReplenishMarketReader{r}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for ReplenishMarket
func (r *ReplenishMarket) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedReplenishMarketReader{r}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for ReplenishMarket
func (r *ReplenishMarket) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedReplenishMarketReader{r}
}

// Implementation for ResetAllPlayerSubmissions

var ȧutoGeneratedResetAllPlayerSubmissionsReaderProps = map[string]boardgame.PropertyType{}

type ȧutoGeneratedResetAllPlayerSubmissionsReader struct {
	data *ResetAllPlayerSubmissions
}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedResetAllPlayerSubmissionsReaderProps
}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) Prop(name string) (interface{}, error) {
	props := r.Props()
	propType, ok := props[name]
...
func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) PropMutable(name string) bool {
	switch name {
	}
...
func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) SetProp(name string, value interface{}) error {
	props := r.Props()
	propType, ok := props[name]
...
func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ConfigureProp(name string, value interface{}) error {
	props := r.Props()
	propType, ok := props[name]
...
func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {

	return 0, errors.New("No such PlayerIndex prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndex prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (r *ȧutoGeneratedResetAllPlayerSubmissionsReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for ResetAllPlayerSubmissions
func (r *ResetAllPlayerSubmissions) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedResetAllPlayerSubmissionsReader{r}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for ResetAllPlayerSubmissions
func (r *ResetAllPlayerSubmissions) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedResetAllPlayerSubmissionsReader{r}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for ResetAllPlayerSubmissions
func (r *ResetAllPlayerSubmissions) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedResetAllPlayerSubmissionsReader{r}
}
...
// Implementation for SeatPlayer

var ȧutoGeneratedSeatPlayerReaderProps = map[string]boardgame.PropertyType{
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedSeatPlayerReader struct {
	data *SeatPlayer
}

func (s *ȧutoGeneratedSeatPlayerReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedSeatPlayerReaderProps
}

func (s *ȧutoGeneratedSeatPlayerReader) Prop(name string) (interface{}, error) {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSeatPlayerReader) PropMutable(name string) bool {
	switch name {
	case "TargetPlayerIndex":
		return true
	}
...
func (s *ȧutoGeneratedSeatPlayerReader) SetProp(name string, value interface{}) error {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSeatPlayerReader) ConfigureProp(name string, value interface{}) error {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSeatPlayerReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {

	switch name {
	case "TargetPlayerIndex":
		return s.data.TargetPlayerIndex, nil
...
func (s *ȧutoGeneratedSeatPlayerReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {

	switch name {
	case "TargetPlayerIndex":
		s.data.TargetPlayerIndex = value
		return nil
...
func (s *ȧutoGeneratedSeatPlayerReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (s *ȧutoGeneratedSeatPlayerReader) TimerProp(name string) (boardgame.Timer, error) {
...
// Implementation for CloseEmptySeat

var ȧutoGeneratedCloseEmptySeatReaderProps = map[string]boardgame.PropertyType{
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedCloseEmptySeatReader struct {
	data *CloseEmptySeat
}

func (c *ȧutoGeneratedCloseEmptySeatReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedCloseEmptySeatReaderProps
}

func (c *ȧutoGeneratedCloseEmptySeatReader) Prop(name string) (interface{}, error) {
	props := c.Props()
	propType, ok := props[name]
...
func (c *ȧutoGeneratedCloseEmptySeatReader) PropMutable(name string) bool {
	switch name {
	case "TargetPlayerIndex":
		return true
	}
...
func (c *ȧutoGeneratedCloseEmptySeatReader) SetProp(name string, value interface{}) error {
	props := c.Props()
	propType, ok := props[name]
...
func (c *ȧutoGeneratedCloseEmptySeatReader) ConfigureProp(name string, value interface{}) error {
	props := c.Props()
	propType, ok := props[name]
...
func (c *ȧutoGeneratedCloseEmptySeatReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {
...
func (c *ȧutoGeneratedCloseEmptySeatReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {
...
func (c *ȧutoGeneratedCloseEmptySeatReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (c *ȧutoGeneratedCloseEmptySeatReader) TimerProp(name string) (boardgame.Timer, error) {
...
// Implementation for InactivateEmptySeat

var ȧutoGeneratedInactivateEmptySeatReaderProps = map[string]boardgame.PropertyType{
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedInactivateEmptySeatReader struct {
	data *InactivateEmptySeat
}

func (i *ȧutoGeneratedInactivateEmptySeatReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedInactivateEmptySeatReaderProps
}

func (i *ȧutoGeneratedInactivateEmptySeatReader) Prop(name string) (interface{}, error) {
	props := i.Props()
	propType, ok := props[name]
...
func (i *ȧutoGeneratedInactivateEmptySeatReader) PropMutable(name string) bool {
	switch name {
	case "TargetPlayerIndex":
		return true
	}
...
func (i *ȧutoGeneratedInactivateEmptySeatReader) SetProp(name string, value interface{}) error {
	props := i.Props()
	propType, ok := props[name]
...
func (i *ȧutoGeneratedInactivateEmptySeatReader) ConfigureProp(name string, value interface{}) error {
	props := i.Props()
	propType, ok := props[name]
...
func (i *ȧutoGeneratedInactivateEmptySeatReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {

	switch name {
	case "TargetPlayerIndex":
		return i.data.TargetPlayerIndex, nil
...
func (i *ȧutoGeneratedInactivateEmptySeatReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {

	switch name {
	case "TargetPlayerIndex":
		i.data.TargetPlayerIndex = value
		return nil
...
func (i *ȧutoGeneratedInactivateEmptySeatReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (i *ȧutoGeneratedInactivateEmptySeatReader) TimerProp(name string) (boardgame.Timer, error) {
...
// Implementation for ActivateEmptySeat

var ȧutoGeneratedActivateEmptySeatReaderProps = map[string]boardgame.PropertyType{
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedActivateEmptySeatReader struct {
	data *ActivateEmptySeat
}

func (a *ȧutoGeneratedActivateEmptySeatReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedActivateEmptySeatReaderProps
}

func (a *ȧutoGeneratedActivateEmptySeatReader) Prop(name string) (interface{}, error) {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedActivateEmptySeatReader) PropMutable(name string) bool {
	switch name {
	case "TargetPlayerIndex":
		return true
	}
...
func (a *ȧutoGeneratedActivateEmptySeatReader) SetProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedActivateEmptySeatReader) ConfigureProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedActivateEmptySeatReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {
...
func (a *ȧutoGeneratedActivateEmptySeatReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {
...
func (a *ȧutoGeneratedActivateEmptySeatReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateEmptySeatReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for ActivateEmptySeat
func (a *ActivateEmptySeat) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedActivateEmptySeatReader{a}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for ActivateEmptySeat
func (a *ActivateEmptySeat) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedActivateEmptySeatReader{a}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for ActivateEmptySeat
func (a *ActivateEmptySeat) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedActivateEmptySeatReader{a}
}

// Implementation for ActivateFilledSeat

var ȧutoGeneratedActivateFilledSeatReaderProps = map[string]boardgame.PropertyType{
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedActivateFilledSeatReader struct {
	data *ActivateFilledSeat
}

func (a *ȧutoGeneratedActivateFilledSeatReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedActivateFilledSeatReaderProps
}

func (a *ȧutoGeneratedActivateFilledSeatReader) Prop(name string) (interface{}, error) {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedActivateFilledSeatReader) PropMutable(name string) bool {
	switch name {
	case "TargetPlayerIndex":
		return true
	}
...
func (a *ȧutoGeneratedActivateFilledSeatReader) SetProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedActivateFilledSeatReader) ConfigureProp(name string, value interface{}) error {
	props := a.Props()
	propType, ok := props[name]
...
func (a *ȧutoGeneratedActivateFilledSeatReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {
...
func (a *ȧutoGeneratedActivateFilledSeatReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {
...
func (a *ȧutoGeneratedActivateFilledSeatReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (a *ȧutoGeneratedActivateFilledSeatReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for ActivateFilledSeat
func (a *ActivateFilledSeat) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedActivateFilledSeatReader{a}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for ActivateFilledSeat
func (a *ActivateFilledSeat) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedActivateFilledSeatReader{a}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for ActivateFilledSeat
func (a *ActivateFilledSeat) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedActivateFilledSeatReader{a}
}

// Implementation for CloseAllSeats

var ȧutoGeneratedCloseAllSeatsReaderProps = map[string]boardgame.PropertyType{}

type ȧutoGeneratedCloseAllSeatsReader struct {
	data *CloseAllSeats
}

func (c *ȧutoGeneratedCloseAllSeatsReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedCloseAllSeatsReaderProps
}

func (c *ȧutoGeneratedCloseAllSeatsReader) Prop(name string) (interface{}, error) {
	props := c.Props()
	propType, ok := props[name]
...
func (c *ȧutoGeneratedCloseAllSeatsReader) PropMutable(name string) bool {
	switch name {
	}
...
func (c *ȧutoGeneratedCloseAllSeatsReader) SetProp(name string, value interface{}) error {
	props := c.Props()
	propType, ok := props[name]
...
func (c *ȧutoGeneratedCloseAllSeatsReader) ConfigureProp(name string, value interface{}) error {
	props := c.Props()
	propType, ok := props[name]
...
func (c *ȧutoGeneratedCloseAllSeatsReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {

	return 0, errors.New("No such PlayerIndex prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndex prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (c *ȧutoGeneratedCloseAllSeatsReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for CloseAllSeats
func (c *CloseAllSeats) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedCloseAllSeatsReader{c}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for CloseAllSeats
func (c *CloseAllSeats) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedCloseAllSeatsReader{c}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for CloseAllSeats
func (c *CloseAllSeats) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedCloseAllSeatsReader{c}
}

// Implementation for WaitForEnoughPlayers

var ȧutoGeneratedWaitForEnoughPlayersReaderProps = map[string]boardgame.PropertyType{}

type ȧutoGeneratedWaitForEnoughPlayersReader struct {
	data *WaitForEnoughPlayers
}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedWaitForEnoughPlayersReaderProps
}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) Prop(name string) (interface{}, error) {
	props := w.Props()
	propType, ok := props[name]
	...
	switch propType {
	case boardgame.TypeInt:
		return w.IntProp(name)
	case boardgame.TypeBool:
		return w.BoolProp(name)
	case boardgame.TypeString:
		return w.StringProp(name)
	case boardgame.TypePlayerIndex:
		return w.PlayerIndexProp(name)
	case boardgame.TypeEnum:
		return w.ImmutableEnumProp(name)
	case boardgame.TypeIntSlice:
		return w.IntSliceProp(name)
	case boardgame.TypeBoolSlice:
		return w.BoolSliceProp(name)
	case boardgame.TypeStringSlice:
		return w.StringSliceProp(name)
	case boardgame.TypePlayerIndexSlice:
		return w.PlayerIndexSliceProp(name)
	case boardgame.TypeStack:
		return w.ImmutableStackProp(name)
	case boardgame.TypeBoard:
...
func (w *ȧutoGeneratedWaitForEnoughPlayersReader) PropMutable(name string) bool {
	switch name {
	}
...
func (w *ȧutoGeneratedWaitForEnoughPlayersReader) SetProp(name string, value interface{}) error {
	props := w.Props()
	propType, ok := props[name]
	...
	case boardgame.TypeInt:
		...
		return w.SetIntProp(name, val)
	case boardgame.TypeBool:
		val, ok := value.(bool)
		if !ok {
			return errors.New("Provided value was not of type bool")
		}
		return w.SetBoolProp(name, val)
	case boardgame.TypeString:
		val, ok := value.(string)
		if !ok {
			return errors.New("Provided value was not of type string")
		}
		return w.SetStringProp(name, val)
	case boardgame.TypePlayerIndex:
		val, ok := value.(boardgame.PlayerIndex)
		if !ok {
			return errors.New("Provided value was not of type boardgame.PlayerIndex")
		}
		return w.SetPlayerIndexProp(name, val)
	case boardgame.TypeEnum:
		return errors.New("SetProp does not allow setting mutable types; use ConfigureProp instead")
	case boardgame.TypeIntSlice:
		val, ok := value.([]int)
		...
		return w.SetIntSliceProp(name, val)
	case boardgame.TypeBoolSlice:
		val, ok := value.([]bool)
		if !ok {
			return errors.New("Provided value was not of type []bool")
		}
		return w.SetBoolSliceProp(name, val)
	case boardgame.TypeStringSlice:
		val, ok := value.([]string)
		if !ok {
			return errors.New("Provided value was not of type []string")
		}
		return w.SetStringSliceProp(name, val)
	case boardgame.TypePlayerIndexSlice:
		val, ok := value.([]boardgame.PlayerIndex)
		if !ok {
			return errors.New("Provided value was not of type []boardgame.PlayerIndex")
		}
		return w.SetPlayerIndexSliceProp(name, val)
	case boardgame.TypeStack:
		return errors.New("SetProp does not allow setting mutable types; use ConfigureProp instead")
	case boardgame.TypeBoard:
		return errors.New("SetProp does not allow setting mutable types; use ConfigureProp instead")
...
func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ConfigureProp(name string, value interface{}) error {
	props := w.Props()
	propType, ok := props[name]
	...
	case boardgame.TypeEnum:
		if w.PropMutable(name) {
			...
			return w.ConfigureEnumProp(name, val)
		}
		//Immutable variant
		val, ok := value.(enum.ImmutableVal)
		if !ok {
		...
		return w.ConfigureImmutableEnumProp(name, val)
	case boardgame.TypeIntSlice:
		val, ok := value.([]int)
		if !ok {
			return errors.New("Provided value was not of type []int")
	...
	case boardgame.TypeStack:
		if w.PropMutable(name) {
			...
			return w.ConfigureStackProp(name, val)
		}
		//Immutable variant
		val, ok := value.(boardgame.ImmutableStack)
		if !ok {
		...
		return w.ConfigureImmutableStackProp(name, val)
	case boardgame.TypeBoard:
		if w.PropMutable(name) {
			//Mutable variant
			val, ok := value.(boardgame.Board)
			...
			return w.ConfigureBoardProp(name, val)
		}
		//Immutable variant
		val, ok := value.(boardgame.ImmutableBoard)
		if !ok {
		...
		return w.ConfigureImmutableBoardProp(name, val)
	case boardgame.TypeTimer:
		if w.PropMutable(name) {
			//Mutable variant
			val, ok := value.(boardgame.Timer)
			...
			return w.ConfigureTimerProp(name, val)
		}
		//Immutable variant
		val, ok := value.(boardgame.ImmutableTimer)
		if !ok {
...
func (w *ȧutoGeneratedWaitForEnoughPlayersReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {

	return 0, errors.New("No such PlayerIndex prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndex prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (w *ȧutoGeneratedWaitForEnoughPlayersReader) TimerProp(name string) (boardgame.Timer, error) {
...
// Implementation for SelectColor

var ȧutoGeneratedSelectColorReaderProps = map[string]boardgame.PropertyType{
	"SelectedColor":     boardgame.TypeEnum,
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedSelectColorReader struct {
	data *SelectColor
}

func (s *ȧutoGeneratedSelectColorReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedSelectColorReaderProps
}

func (s *ȧutoGeneratedSelectColorReader) Prop(name string) (interface{}, error) {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSelectColorReader) PropMutable(name string) bool {
	switch name {
	case "SelectedColor":
		return true
	case "TargetPlayerIndex":
...
func (s *ȧutoGeneratedSelectColorReader) SetProp(name string, value interface{}) error {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSelectColorReader) ConfigureProp(name string, value interface{}) error {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSelectColorReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {
...
func (s *ȧutoGeneratedSelectColorReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {
...
func (s *ȧutoGeneratedSelectColorReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	switch name {
	case "SelectedColor":
		return s.data.SelectedColor, nil
...
func (s *ȧutoGeneratedSelectColorReader) ConfigureEnumProp(name string, value enum.Val) error {

	switch name {
	case "SelectedColor":
		s.data.SelectedColor = value
		return nil
...
func (s *ȧutoGeneratedSelectColorReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {
...
func (s *ȧutoGeneratedSelectColorReader) EnumProp(name string) (enum.Val, error) {
...
func (s *ȧutoGeneratedSelectColorReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectColorReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for SelectColor
func (s *SelectColor) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedSelectColorReader{s}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for SelectColor
func (s *SelectColor) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedSelectColorReader{s}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for SelectColor
func (s *SelectColor) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedSelectColorReader{s}
}

// Implementation for SelectRole

var ȧutoGeneratedSelectRoleReaderProps = map[string]boardgame.PropertyType{
	"SelectedRole":      boardgame.TypeEnum,
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedSelectRoleReader struct {
	data *SelectRole
}

func (s *ȧutoGeneratedSelectRoleReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedSelectRoleReaderProps
}

func (s *ȧutoGeneratedSelectRoleReader) Prop(name string) (interface{}, error) {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSelectRoleReader) PropMutable(name string) bool {
	switch name {
	case "SelectedRole":
		return true
	case "TargetPlayerIndex":
...
func (s *ȧutoGeneratedSelectRoleReader) SetProp(name string, value interface{}) error {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSelectRoleReader) ConfigureProp(name string, value interface{}) error {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSelectRoleReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {
...
func (s *ȧutoGeneratedSelectRoleReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {
...
func (s *ȧutoGeneratedSelectRoleReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	switch name {
	case "SelectedRole":
		return s.data.SelectedRole, nil
...
func (s *ȧutoGeneratedSelectRoleReader) ConfigureEnumProp(name string, value enum.Val) error {

	switch name {
	case "SelectedRole":
		s.data.SelectedRole = value
		return nil
...
func (s *ȧutoGeneratedSelectRoleReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {
...
func (s *ȧutoGeneratedSelectRoleReader) EnumProp(name string) (enum.Val, error) {
...
func (s *ȧutoGeneratedSelectRoleReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectRoleReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for SelectRole
func (s *SelectRole) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedSelectRoleReader{s}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for SelectRole
func (s *SelectRole) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedSelectRoleReader{s}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for SelectRole
func (s *SelectRole) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedSelectRoleReader{s}
}

// Implementation for SelectTeam

var ȧutoGeneratedSelectTeamReaderProps = map[string]boardgame.PropertyType{
	"SelectedTeam":      boardgame.TypeEnum,
	"TargetPlayerIndex": boardgame.TypePlayerIndex,
}

type ȧutoGeneratedSelectTeamReader struct {
	data *SelectTeam
}

func (s *ȧutoGeneratedSelectTeamReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedSelectTeamReaderProps
}

func (s *ȧutoGeneratedSelectTeamReader) Prop(name string) (interface{}, error) {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSelectTeamReader) PropMutable(name string) bool {
	switch name {
	case "SelectedTeam":
		return true
	case "TargetPlayerIndex":
...
func (s *ȧutoGeneratedSelectTeamReader) SetProp(name string, value interface{}) error {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSelectTeamReader) ConfigureProp(name string, value interface{}) error {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedSelectTeamReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {
...
func (s *ȧutoGeneratedSelectTeamReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {
...
func (s *ȧutoGeneratedSelectTeamReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	switch name {
	case "SelectedTeam":
		return s.data.SelectedTeam, nil
...
func (s *ȧutoGeneratedSelectTeamReader) ConfigureEnumProp(name string, value enum.Val) error {

	switch name {
	case "SelectedTeam":
		s.data.SelectedTeam = value
		return nil
...
func (s *ȧutoGeneratedSelectTeamReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {
...
func (s *ȧutoGeneratedSelectTeamReader) EnumProp(name string) (enum.Val, error) {
...
func (s *ȧutoGeneratedSelectTeamReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (s *ȧutoGeneratedSelectTeamReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for SelectTeam
func (s *SelectTeam) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedSelectTeamReader{s}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for SelectTeam
func (s *SelectTeam) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedSelectTeamReader{s}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for SelectTeam
func (s *SelectTeam) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedSelectTeamReader{s}
}

// Implementation for ShuffleDiscardIntoDraw

var ȧutoGeneratedShuffleDiscardIntoDrawReaderProps = map[string]boardgame.PropertyType{}

type ȧutoGeneratedShuffleDiscardIntoDrawReader struct {
	data *ShuffleDiscardIntoDraw
}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) Props() map[string]boardgame.PropertyType {
	return ȧutoGeneratedShuffleDiscardIntoDrawReaderProps
}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) Prop(name string) (interface{}, error) {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) PropMutable(name string) bool {
	switch name {
	}
...
func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) SetProp(name string, value interface{}) error {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ConfigureProp(name string, value interface{}) error {
	props := s.Props()
	propType, ok := props[name]
...
func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) IntProp(name string) (int, error) {

	return 0, errors.New("No such Int prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) SetIntProp(name string, value int) error {

	return errors.New("No such Int prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) BoolProp(name string) (bool, error) {

	return false, errors.New("No such Bool prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) SetBoolProp(name string, value bool) error {

	return errors.New("No such Bool prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) StringProp(name string) (string, error) {

	return "", errors.New("No such String prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) SetStringProp(name string, value string) error {

	return errors.New("No such String prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) PlayerIndexProp(name string) (boardgame.PlayerIndex, error) {

	return 0, errors.New("No such PlayerIndex prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) SetPlayerIndexProp(name string, value boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndex prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ImmutableEnumProp(name string) (enum.ImmutableVal, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ConfigureEnumProp(name string, value enum.Val) error {

	return errors.New("No such Enum prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ConfigureImmutableEnumProp(name string, value enum.ImmutableVal) error {

	return errors.New("No such ImmutableEnum prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) EnumProp(name string) (enum.Val, error) {

	return nil, errors.New("No such Enum prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) IntSliceProp(name string) ([]int, error) {

	return []int{}, errors.New("No such IntSlice prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) SetIntSliceProp(name string, value []int) error {

	return errors.New("No such IntSlice prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) BoolSliceProp(name string) ([]bool, error) {

	return []bool{}, errors.New("No such BoolSlice prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) SetBoolSliceProp(name string, value []bool) error {

	return errors.New("No such BoolSlice prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) StringSliceProp(name string) ([]string, error) {

	return []string{}, errors.New("No such StringSlice prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) SetStringSliceProp(name string, value []string) error {

	return errors.New("No such StringSlice prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) PlayerIndexSliceProp(name string) ([]boardgame.PlayerIndex, error) {

	return []boardgame.PlayerIndex{}, errors.New("No such PlayerIndexSlice prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) SetPlayerIndexSliceProp(name string, value []boardgame.PlayerIndex) error {

	return errors.New("No such PlayerIndexSlice prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ImmutableStackProp(name string) (boardgame.ImmutableStack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ConfigureStackProp(name string, value boardgame.Stack) error {

	return errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ConfigureImmutableStackProp(name string, value boardgame.ImmutableStack) error {

	return errors.New("No such ImmutableStack prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) StackProp(name string) (boardgame.Stack, error) {

	return nil, errors.New("No such Stack prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ImmutableBoardProp(name string) (boardgame.ImmutableBoard, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ConfigureBoardProp(name string, value boardgame.Board) error {

	return errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ConfigureImmutableBoardProp(name string, value boardgame.ImmutableBoard) error {

	return errors.New("No such ImmutableBoard prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) BoardProp(name string) (boardgame.Board, error) {

	return nil, errors.New("No such Board prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ImmutableTimerProp(name string) (boardgame.ImmutableTimer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ConfigureTimerProp(name string, value boardgame.Timer) error {

	return errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ConfigureImmutableTimerProp(name string, value boardgame.ImmutableTimer) error {

	return errors.New("No such ImmutableTimer prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) TimerProp(name string) (boardgame.Timer, error) {

	return nil, errors.New("No such Timer prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ImmutableEnumSliceProp(name string) (enum.ImmutableEnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ConfigureEnumSliceProp(name string, value enum.EnumSlice) error {

	return errors.New("No such EnumSlice prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) ConfigureImmutableEnumSliceProp(name string, value enum.ImmutableEnumSlice) error {

	return errors.New("No such ImmutableEnumSlice prop: " + name)

}

func (s *ȧutoGeneratedShuffleDiscardIntoDrawReader) EnumSliceProp(name string) (enum.EnumSlice, error) {

	return nil, errors.New("No such EnumSlice prop: " + name)

}

// Reader returns an autp-generated boardgame.PropertyReader for ShuffleDiscardIntoDraw
func (s *ShuffleDiscardIntoDraw) Reader() boardgame.PropertyReader {
	return &ȧutoGeneratedShuffleDiscardIntoDrawReader{s}
}

// ReadSetter returns an autp-generated boardgame.PropertyReadSetter for ShuffleDiscardIntoDraw
func (s *ShuffleDiscardIntoDraw) ReadSetter() boardgame.PropertyReadSetter {
	return &ȧutoGeneratedShuffleDiscardIntoDrawReader{s}
}

// ReadSetConfigurer returns an autp-generated boardgame.PropertyReadSetConfigurer for ShuffleDiscardIntoDraw
func (s *ShuffleDiscardIntoDraw) ReadSetConfigurer() boardgame.PropertyReadSetConfigurer {
	return &ȧutoGeneratedShuffleDiscardIntoDrawReader{s}
}
