...
your gameState should implement CurrentPlayerSetter. In practice because most
of the logic is contained on your game and playerStates, you can often use
this move directly in your game, with no configuration override or embedding,
like so:
