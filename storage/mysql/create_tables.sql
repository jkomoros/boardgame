...
create table if not exists `states` (`Id` bigint not null primary key auto_increment, `GameId` varchar(16), `Version` bigint, `Blob` mediumblob)  engine=InnoDB charset=utf8;
