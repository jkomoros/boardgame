...
type GameDelegate interface {
	...
	//from GroupEnum's enum, and are generated by GroupMembership (for
	//playerStates; emptyMap for others), then extending with
	//GroupAll,GroupSelf,GroupOther membership as appropriate.
