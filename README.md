...
**Animation effects:** Games can add deterministic bursts, pulses, travel, and
composed semantic effects without managing particles, cleanup, synchronization,
or accessibility themselves. See the [animation effects guide](docs/animation-effects.md)
and the working `examples/memory` and `examples/debuganimations` renderers.
