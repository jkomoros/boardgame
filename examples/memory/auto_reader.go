...
func (m *__MoveRevealCardReader) EnumConstProp(name string) (enum.Const, error) {

	return nil, errors.New("No such EnumConst prop: " + name)

}

func (m *__MoveRevealCardReader) SetEnumConstProp(name string, value enum.Const) error {

	return errors.New("No such EnumConst prop: " + name)

}

func (m *__MoveRevealCardReader) EnumVarProp(name string) (enum.Var, error) {

	return nil, errors.New("No such EnumVar prop: " + name)

}

func (m *__MoveRevealCardReader) SetEnumVarProp(name string, value enum.Var) error {
...
func (m *__MoveStartHideCardsTimerReader) EnumConstProp(name string) (enum.Const, error) {

	return nil, errors.New("No such EnumConst prop: " + name)

}

func (m *__MoveStartHideCardsTimerReader) SetEnumConstProp(name string, value enum.Const) error {

	return errors.New("No such EnumConst prop: " + name)

}

func (m *__MoveStartHideCardsTimerReader) EnumVarProp(name string) (enum.Var, error) {

	return nil, errors.New("No such EnumVar prop: " + name)

}

func (m *__MoveStartHideCardsTimerReader) SetEnumVarProp(name string, value enum.Var) error {
...
func (m *__MoveCaptureCardsReader) EnumConstProp(name string) (enum.Const, error) {

	return nil, errors.New("No such EnumConst prop: " + name)

}

func (m *__MoveCaptureCardsReader) SetEnumConstProp(name string, value enum.Const) error {

	return errors.New("No such EnumConst prop: " + name)

}

func (m *__MoveCaptureCardsReader) EnumVarProp(name string) (enum.Var, error) {

	return nil, errors.New("No such EnumVar prop: " + name)

}

func (m *__MoveCaptureCardsReader) SetEnumVarProp(name string, value enum.Var) error {
...
func (m *__MoveHideCardsReader) EnumConstProp(name string) (enum.Const, error) {

	return nil, errors.New("No such EnumConst prop: " + name)

}

func (m *__MoveHideCardsReader) SetEnumConstProp(name string, value enum.Const) error {

	return errors.New("No such EnumConst prop: " + name)

}

func (m *__MoveHideCardsReader) EnumVarProp(name string) (enum.Var, error) {

	return nil, errors.New("No such EnumVar prop: " + name)

}

func (m *__MoveHideCardsReader) SetEnumVarProp(name string, value enum.Var) error {
