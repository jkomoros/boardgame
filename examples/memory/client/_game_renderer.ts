...
export interface GameClientContract {
  ...
  readonly RendererTag:
    | 'boardgame-render-game-memory'
    | 'boardgame-render-game-memory-table'
    | 'boardgame-render-game-memory-hand';
}
...
function registerRenderer<Base extends HTMLElement>(
  ...
  if (!(constructor.prototype instanceof expectedBase)) {
    throw new Error(
      '[memory] ' + surfaceName + ' renderer ' + constructorName +
  ...
  if (existing) {
    throw new Error(
      '[memory] cannot register ' + surfaceName + ' renderer ' + constructorName +
...
export function registerGameRenderer<T extends RendererConstructor<GameRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-game-memory', 'game', 'GameRenderer', GameRenderer, constructor,
  );
}
...
export function registerTableRenderer<T extends RendererConstructor<TableRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-game-memory-table', 'table', 'TableRenderer', TableRenderer, constructor,
  );
}
...
export function registerHandRenderer<T extends RendererConstructor<HandRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-game-memory-hand', 'hand', 'HandRenderer', HandRenderer, constructor,
  );
}
...
export function registerPlayerInfoRenderer<T extends RendererConstructor<PlayerInfoRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-player-info-memory',
    'player info',
    'PlayerInfoRenderer',
    PlayerInfoRenderer,
    constructor,
