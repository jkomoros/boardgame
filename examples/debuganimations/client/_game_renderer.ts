...
function registerRenderer<Base extends HTMLElement>(
  ...
  if (!(constructor.prototype instanceof expectedBase)) {
    throw new Error(
      '[debuganimations] ' + surfaceName + ' renderer ' + constructorName +
  ...
  if (existing) {
    throw new Error(
      '[debuganimations] cannot register ' + surfaceName + ' renderer ' + constructorName +
...
export function registerGameRenderer<T extends RendererConstructor<GameRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-game-debuganimations', 'game', 'GameRenderer', GameRenderer, constructor,
  );
}
...
export function registerTableRenderer<T extends RendererConstructor<TableRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-game-debuganimations-table', 'table', 'TableRenderer', TableRenderer, constructor,
  );
}
...
export function registerHandRenderer<T extends RendererConstructor<HandRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-game-debuganimations-hand', 'hand', 'HandRenderer', HandRenderer, constructor,
  );
}
...
export function registerPlayerInfoRenderer<T extends RendererConstructor<PlayerInfoRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-player-info-debuganimations',
    'player info',
    'PlayerInfoRenderer',
    PlayerInfoRenderer,
    constructor,
