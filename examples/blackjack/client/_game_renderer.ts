...
function registerRenderer<Base extends HTMLElement>(
  ...
  if (!(constructor.prototype instanceof expectedBase)) {
    throw new Error(
      '[blackjack] ' + surfaceName + ' renderer ' + constructorName +
  ...
  if (existing) {
    throw new Error(
      '[blackjack] cannot register ' + surfaceName + ' renderer ' + constructorName +
...
export function registerGameRenderer<T extends RendererConstructor<GameRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-game-blackjack', 'game', 'GameRenderer', GameRenderer, constructor,
  );
}
...
export function registerTableRenderer<T extends RendererConstructor<TableRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-game-blackjack-table', 'table', 'TableRenderer', TableRenderer, constructor,
  );
}
...
export function registerHandRenderer<T extends RendererConstructor<HandRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-game-blackjack-hand', 'hand', 'HandRenderer', HandRenderer, constructor,
  );
}
...
export function registerPlayerInfoRenderer<T extends RendererConstructor<PlayerInfoRenderer>>(
  ...
  registerRenderer(
    'boardgame-render-player-info-blackjack',
    'player info',
    'PlayerInfoRenderer',
    PlayerInfoRenderer,
    constructor,
